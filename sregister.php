...
<body id="Body" >
    ...
    <ul class="nav nav-tabs" id="color">
      ...
      <li role="presentation" class="active"  ><a href="sregister.php" id="lic2" >Suplier New account</a></li>
      <li role="presentation" ><a href="product.php" id="lic3">Add product</a></li>
      <li role="presentation"><a href="expenses.php" id="lic3" >Expenses</a></li>
    ...
    <div class="col-md-4 col-md-offset-0" >
      ...
      <h1 class="headline">Create New Supplier Account</h1>
      <form class="form-horizontal" id="formid" method="post" action="registerUser.php" enctype="multipart/form-data">
